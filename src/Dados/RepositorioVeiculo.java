...
public class RepositorioVeiculo  implements InterfaceRepositorioVeiculo
{
    ...
    private void lerArquivo() throws ClassNotFoundException, VeiculoNaoExisteException
    {
	  ...
	  {
		 e.printStackTrace();
		 //throw new RepositorioException("Erro na leitura do objeto. Objeto "+ (new RepositorioCliente()).getClass()+ " n�o encontrado.");
	  } 
	  finally 
	  {
		 try 
	...
	public List<Veiculo> ListarVeiculosDisponiveis() throws VeiculosAlugadosException
	{
		List<Veiculo> veiculosdisponiveis = new ArrayList<Veiculo>();
		   ...
		   {
			   throw new VeiculosAlugadosException("nao Existem veiculos dispon�veis");	
		   }
		   else
		   {   
